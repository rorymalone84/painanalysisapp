<template>
  <Head title="Settings" />
  <h1 class="text-3xl">Doctors Home</h1>
        ...
        <div class="bg-cyan-900 border rounded shadow p-2">
          <div class="flex flex-row items-center">
            ...
            <div class="flex-1 text-right">
              <h5 class="text-white">Consults</h5>
              <h3 class="text-white text-3xl">Next consult</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="bg-cyan-700 border rounded shadow p-2">
          <div class="flex flex-row items-center">
            ...
            <div class="flex-1 text-right">
              ...
              <h3 class="text-white text-3xl">Next Appointment</h3>
            </div>
          </div>
        </div>
      </div>
